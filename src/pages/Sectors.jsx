...
const Sectors = () => {
  ...
  return (
    <>
      <div className="sectors-hero py-5" style={{ background: 'linear-gradient(135deg, #fff 0%, #C9A13B 100%)' }}>
        <Container>
          ...
          >
            <h1 className="display-4 fw-bold mb-3" style={{ color: '#C9A13B' }}>Our Sectors</h1>
            <p className="lead mb-0" style={{ color: '#222' }}>
              GODIMEWUL represents workers across diverse sectors, ensuring fair treatment, 
              safe working conditions, and professional development opportunities.
            </p>
          </motion.div>
        </Container>
      </div>
  ...
  <Container className="py-5">
      ...
      {sectors.map((sector, idx) => (
            <Col lg={6} xl={3} key={sector.id}>
              <motion.div variants={cardVariants}>
                <Card 
                  className="h-100 shadow-lg border-0 sector-card"
                  style={{ 
                    background: `linear-gradient(135deg, ${sector.bgColor} 0%, white 100%)`,
                    cursor: 'pointer',
                ...
                >
                  <Card.Body className="text-center p-4">
                    ...
                    <Card.Title className="fw-bold mb-3" style={{ color: sector.color }}>
                      {sector.title}
                    </Card.Title>
                    ...
                    <Button 
                      ...
                      onClick={e => { e.stopPropagation(); navigate(`/sectors/${sector.id}`); }}
                      onMouseEnter={e => {
                        e.target.style.backgroundColor = sector.color;
                        e.target.style.color = 'white';
                      }}
                      onMouseLeave={e => {
                        e.target.style.backgroundColor = 'transparent';
                        e.target.style.color = sector.color;
                      }}
                    >
                      Learn More
                    </Button>
